...
public class DataManager {
    ...
    public void insertIntoDirect(String companyName, int phone) {
        try (Connection connection = dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(
                     "insert into shipperName (name) values (?)")) {
    ...
    public void insertIntoWithGeneratedKeys(String companyName, int phone) {
        try (Connection connection = dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(
